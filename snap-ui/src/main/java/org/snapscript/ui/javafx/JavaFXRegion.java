package org.snapscript.ui.javafx;
...
public class JavaFXRegion extends Region {

   private final ClientContext context;
   private final WebEngine engine;
   private final WebView browser;

   public JavaFXRegion(ClientContext context) {
      ...
      engine.getLoadWorker().stateProperty().addListener(new ChangeListener() {
         ...
         public void changed(ObservableValue observable, Object oldValue, Object newValue) {
            try {
               ...
               method.invoke(window, "java", JavaFXRegion.this);
